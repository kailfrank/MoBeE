...
1997 by Mark J. Kilgard. GLUT for Win32 is Copyright 1997 by Nate Robins. You
need to install the GLUT run-time library on Win32 if you want to build the
demos in the SOLID distribution that utilize OpenGL. GLUT for Win32 can be
